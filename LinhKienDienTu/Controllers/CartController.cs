...
namespace LinhKienDienTu.Controllers
{
    ...
    {
        private LinhKienDienTuDbContext db = new LinhKienDienTuDbContext();
        ...
        public void SendOrderConfirmationEmail(String Mail)
        {
            ...
            body += "<div style='text-align: center; margin-top: 20px;'><a href='https://LinhKienDienTu.com' style='display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: #fff; text-decoration: none; border-radius: 5px;'>Kiểm tra đơn hàng</a></div>";
            body += "</td></tr></table>";
